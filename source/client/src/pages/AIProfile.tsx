        ...
        <section id="home" className="hero ai-console-hero section-anchor" data-section>
          ...
          <div className="hero-layout ai-console-layout">
            <div className="hero-copy" data-reveal>
              ...
              <p className="hero-intro">HKUST RMBI student and technical product builder with recent U.S. equities operations experience, working across LLM-enabled operations, agent-control workflows, multimodal evidence systems, data automation, and AI-native developer tools.</p>
              ...
              <dl className="hero-credentials"><div><dt>Availability</dt><dd>Open to AI, Markets &amp; Product opportunities</dd></div><div><dt>Recent role</dt><dd>U.S. Equities Operations Intern, BIT</dd></div><div><dt>System posture</dt><dd>Evidence + review</dd></div></dl>
            </div>
